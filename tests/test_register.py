...
from tai_channel_slack import SlackChannel
...
def _import_register_module(stub_app) -> None:
    ...
    sys.modules.pop("tai_channel_slack.register", None)
    sys.modules.pop("tai_channel_slack.inbound", None)
    importlib.import_module("tai_channel_slack.register")
...
def test_bare_package_import_does_not_register():
    # `import tai_channel_slack` (library use) must not touch the app handle or
    ...
    code = "import sys; import tai_channel_slack; assert 'tai_channel_slack.register' not in sys.modules"
